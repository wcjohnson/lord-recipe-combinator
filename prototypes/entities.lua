...
local recipe_combinator = util.merge({
	data.raw["arithmetic-combinator"]["arithmetic-combinator"],
	{
		...
		plus_symbol_sprites = {
			north = {
				filename = "__lord-recipe-combinator__/graphics/rled.png",
				x = 0,
			},
			south = {
				filename = "__lord-recipe-combinator__/graphics/rled.png",
...
data:extend({
	{ type = "custom-event", name = "lord-recipe-combinator-on_tags_changed" },
	{ type = "custom-event", name = "lord-recipe-combinator-on_initialized" },
	{ type = "custom-event", name = "lord-recipe-combinator-on_status" },
})

---@type things.ThingRegistration
local combinator_registration = {
	name = "recipe-combinator-main",
